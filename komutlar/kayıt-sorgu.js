...
module.exports.run = async (client, message, args) => {
 ...
 if(!kullanıcı) {
    ...
    .setDescription(`<a:radeniasiyahtik:780000462698709003> Toplam Kayıtlar:  \`${kayıtlar}\`
    <a:radeniasiyahtik:780000462698709003> Toplam Erkek Kayıtların: \`${erkek}\`
    <a:radeniasiyahtik:780000462698709003> Toplam Kadın Kayıtların: \`${kadın}\`
    `)
...
.setDescription(`<a:radeniasag:781124835799597062> Toplam Kayıtların: \`${kayıtlar1}\`
<a:radeniasag:781124835799597062> Toplam Erkek Kayıtların: \`${erkek1}\`
<a:radeniasag:781124835799597062> Toplam Kadın Kayıtların: \`${kadin1}\`
`)
